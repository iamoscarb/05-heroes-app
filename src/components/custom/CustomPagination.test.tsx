...
describe('CustomPagination', () => {
    ...
    test('should disabled button 3 when we are in page 3', () => {
        ...
        expect(button3.getAttribute('data-variant')).toBe('default');
        expect(button2.getAttribute('data-variant')).toBe('outline');
    });

    test('should change page whhen click on number button', () => {
        ...
        expect(button2.getAttribute('data-variant')).toBe('default');
        expect(button3.getAttribute('data-variant')).toBe('outline');
    });
})