...
export const HeroPage = () => {
    ...
    const { data: superheroData, isError } = useHeroData(`${idSlug}`);
    ...
    return (
        <div className="min-h-screen">
            {/* Header Banner */}
            <div className={`bg-gradient-to-r ${superheroData.universe.toLowerCase() === 'dc' ? 'from-blue-800 to-indigo-900' :
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="text-center">
                            <div className="bg-white/20 rounded-lg p-6 backdrop-blur-sm">
                                <div className="text-3xl font-bold text-white-400">{averagePower}%</div>
